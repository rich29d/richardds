<section class="sec-menu relative zIndex4">
  <div class="cont-menu absolute">

    <!--Menu-->
    <nav>
      <ul>
        <li class="relative">
          <a href="javascript:void(0);" class="relative zIndex4">works</a>
        ...
        <li class="relative">
          <a href="javascript:void(0);" class="relative zIndex4">skills</a>
          <!--Barras que crescem ao dar hover-->
          <div class="effect-hover absolute">
            <div class="bar-effect bar-1"></div>
            <div class="bar-effect bar-2"></div>
        ...
        <li class="relative">
          <a href="javascript:void(0);" class="relative zIndex4">contato</a>
          <!--Barras que crescem ao dar hover-->
          <div class="effect-hover absolute">
            <div class="bar-effect bar-1"></div>
            <div class="bar-effect bar-2"></div>
  ...
  <div class="cont-cel absolute">
    <div class="txt-hey-cel">
      <img src="{{url('img/txt-hey-cel.png')}}" alt="Hey,vams jogar?">
    </div>
    <div class="cel">
